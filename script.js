...
quadrado1.style.background = '#008080';
quadrado2.style.background = '#008080';
 quadrado3.style.background = '#008080';
}
...
function reiniciar()
{
    ...
    for(var i = 1; i <= 9; i++) {
        ...
        quadrado.style.background = '#00b7ff';
        quadrado.style.color = '#00b7ff';
        quadrado.innerHTML = '-';
